...
public class UserDataFacade {
    ...
    public UserBookResponse createUserWithBooks(UserBookRequest userBookRequest) {
        ...
        log.info("Created userDTO: {}", createdUser);
        ...
        List<Long> bookIdList = userBookRequest.getBookRequests()
                ...
                .peek(createdBook -> log.info("Created bookDTO: {}", createdBook))
                .map(BookDto::getId)
                .toList();
    ...
    public UserBookResponse getUserWithBooks(Long userId) {
        ...
        List<Long> bookIdList = bookService.getBookById(userId)
                .stream()
                .map(bookDto -> new BookMapperImpl().bookDtoToBookEntity(bookDto).getId())
